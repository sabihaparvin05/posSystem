<div class="nk-sidebar">           
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li class="mega-menu mega-menu-sm">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="icon-globe-alt menu-icon"></i><span class="nav-text">Peoples</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="./layout-blank.html">Add Customer</a></li>
                    <li><a href="./layout-one-column.html">Customer List</a></li>
                </ul>
                <ul aria-expanded="false">
                    <li><a href="./layout-blank.html">Add User</a></li>
                    <li><a href="./layout-one-column.html">User List</a></li>
                </ul>
                <ul aria-expanded="false">
                    <li><a href="./layout-blank.html">Add Supplier</a></li>
                    <li><a href="./layout-one-column.html">Supplier List</a></li>
                </ul>
            </li>
            <li class="mega-menu mega-menu-sm">
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
            ...
            <li>
                <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    <i class="icon-screen-tablet menu-icon"></i><span class="nav-text">Error</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="./app-profile.html">Error 404</a></li>
