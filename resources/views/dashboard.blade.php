                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img"
                                                    src="{{ asset('images/avatar/1.jpg') }}" alt="Avatar">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('images/users/8.jpg') }}" class="rounded-circle"
                                        alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('images/users/5.jpg') }}" class="rounded-circle"
                                        alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('images/users/7.jpg') }}" class="rounded-circle"
                                        alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{ asset('images/users/1.jpg') }}" class="rounded-circle"
                                        alt="">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('images/avatar/2.jpg') }}"
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('images/avatar/3.jpg') }}"
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('images/avatar/6.jpg') }}"
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('images/avatar/4.jpg') }}"
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('images/avatar/5.jpg') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div id="activity">
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="{{ asset('images/avatar/1.jpg') }}"
                                    ...
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="{{ asset('images/avatar/2.jpg') }}"
                                            class="mr-3 rounded-circle">
                                        <div class="media-body">
                                    ...
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="{{ asset('images/avatar/2.jpg') }}g"
                                            class="mr-3 rounded-circle">
                                        <div class="media-body">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img width="35" src="{{ asset('images/avatar/3.jpg') }}"
                                            class="mr-3 rounded-circle">
                                        <div class="media-body">
